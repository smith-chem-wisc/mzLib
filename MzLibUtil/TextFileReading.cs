...
namespace MzLibUtil
{
    public static class TextFileReading
    {
        ...
        /// 
        /// See also alternative method (commented out below):
        ...
        public static long GetByteOffsetAtCurrentPosition(StreamReader reader)
        {
            ...
            //BindingFlags flags = BindingFlags.DeclaredOnly | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.GetField;
