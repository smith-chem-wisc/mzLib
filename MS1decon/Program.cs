    ...
    internal class Program
    {
        ...
        private static void DoFileDecon(string[] args)
        {
            ...
            if (result.HasErrors == false)
            {
                ...
                {
                    output.WriteLine("Mass\tScore\tNumPeaks\tNumScans\tMinScan\tMaxScan\tTotalIntensity\tObservedCharges\tMostIntenseElutionTime\tMostIntenseCharge\tMostIntenseMz\tNumPeaksInMostIntenseEnvelope");
