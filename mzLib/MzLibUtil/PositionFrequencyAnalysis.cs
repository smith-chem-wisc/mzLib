...
namespace MzLibUtil
{
    ...
    public class UtilPeptide
    {
        ...
        public UtilPeptide(string fullSeq, Dictionary<int, Dictionary<string, UtilModification>> mods = null) 
        {
    ...
    public class PositionFrequencyAnalysis
    {
        ...
        public static Dictionary<string, UtilProteinGroup> PeptidePTMOccupancy(List<Tuple<string, string, List<string>, double>> peptides, bool IncludeNTerminus = true, bool IncludeCTerminus = true)
        {
            ...
            foreach (var pep in peptides)
            {
                ...
                ClassExtensions.RemoveSpecialCharacters(ref baseSeq, @"", @"[.*?]"); // in case it is null or empty and we need to get the base sequence from the full sequence
