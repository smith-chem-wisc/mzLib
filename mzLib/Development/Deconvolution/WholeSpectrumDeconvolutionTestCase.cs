...
{
    internal readonly record struct ExpectedResult(double ExpectedMostAbundantObservedIsotopicMass,
        int ExpectedIonChargeState, int ExpectedIonMz);
    ...
    public class WholeSpectrumDeconvolutionTestCase
    {
        ...
        public WholeSpectrumDeconvolutionTestCase(SampleType sampleType, string sampleInformation, string spectrumPath, int scanNumber,
