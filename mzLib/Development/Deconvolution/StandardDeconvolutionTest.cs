    ...
    public class StandardDeconvolutionTest
    {
        ...
        static StandardDeconvolutionTest()
        {
            ...
            List<SinglePeakDeconvolutionTestCase> singlePeakDeconvolutionTestCases = new()
            {
                ...
                new SinglePeakDeconvolutionTestCase(SampleType.TopDown, "Direct Injection PolyUbiquitin, Averaged",
                ...
                new SinglePeakDeconvolutionTestCase(SampleType.TopDown,
                ...
                new SinglePeakDeconvolutionTestCase(SampleType.TopDown, "Direct Injection Cytochrome C, Averaged",
            ...
            {
                new WholeSpectrumDeconvolutionTestCase(SampleType.TopDown, "Direct Injection PolyUbiquitin, Averaged",
                    ubiquitinPath, 1, 20,
                ...
                new WholeSpectrumDeconvolutionTestCase(SampleType.TopDown, "Direct Injection Human Growth Hormone, Averaged",
                    hghPath, 1, 20,
                ...
                new WholeSpectrumDeconvolutionTestCase(SampleType.TopDown, "Direct Injection Cytochrome C, Averaged",
                    cytoPath, 1, 20,
                ...
                case DeconvolutionType.ClassicDeconvolution:
                    ...
                    switch (sampleType)
                    {
                        case SampleType.TopDown:
                            parameters = new ClassicDeconvolutionParameters(1, 60, 4, 3);
                            break;
                        case SampleType.BottomUp:
                            parameters = new ClassicDeconvolutionParameters(1, 12, 4, 3);
                            break;
                    }
                    break;
        ...
        public static void ClassicDeconvolution_TopScoringResult_SinglePeak(SinglePeakDeconvolutionTestCase testCase)
        {
            // deconvolution
        ...
        /// <summary>
        /// Test fails if classic deconvolution does not have any result that matches the expected
        /// </summary>
        /// <param name="testCase"></param>
        [Test]
        [TestCaseSource(nameof(_singlePeakTestCases))]
        public static void ClassicDeconvolution_AnyResult_SinglePeak(SinglePeakDeconvolutionTestCase testCase)
        {
            // deconvolution
            DeconvolutionParameters deconParameters =
                GetDeconvolutionParameters(testCase.SampleType, DeconvolutionType.ClassicDeconvolution);
        ...
        /// <summary>
        /// Test fails of classic deconvolution results do not contain the entire set of expected results
        /// </summary>
        /// <param name="testCase"></param>
        [Test]
        [TestCaseSource(nameof(_wholeSpectrumDeconvolutionTestCases))]
        public static void ClassicDeconvolution_WholeSpectrum(WholeSpectrumDeconvolutionTestCase testCase)
        {
            // deconvolution
            DeconvolutionParameters deconParameters =
                GetDeconvolutionParameters(testCase.SampleType, DeconvolutionType.ClassicDeconvolution);
