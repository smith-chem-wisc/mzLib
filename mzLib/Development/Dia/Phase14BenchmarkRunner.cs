...
namespace Development.Dia
{
    ...
    /// Step 14:    TSV export with full column set (5+4+35+6+16 = 66 columns)
    ///
    ...
    public static class Phase14BenchmarkRunner
    {
            ...
            string outputTsvPath)
        {
            ...
            // ════════════════════════════════════════════════════════════
            //  Step 7: Feature computation (35 features)
            // ════════════════════════════════════════════════════════════
            Console.WriteLine("--- Step 7: Computing feature vectors --------------------------");

            Console.WriteLine($"  DEBUG Ms1ScanCount: {index.Ms1ScanCount}");
            Console.WriteLine($"  DEBUG RtWindowStart[0]: {results[0].RtWindowStart}");
            Console.WriteLine($"  DEBUG RtWindowEnd[0]: {results[0].RtWindowEnd}");
            Console.WriteLine($"  DEBUG PrecursorMz[0]: {results[0].PrecursorMz}");
            ...
            //    3. Feature vector:  FV_0 .. FV_34  (35 features via WriteTo)
        ...
        //
        //  Group 3 — Feature vector (35 cols):
