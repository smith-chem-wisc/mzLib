namespace Omics.Fragmentation
{
    ...
    {
        // Product types that are in the same "family" as the input product type. This means they share a backbone cleavage site and direction. For example, a, a*, a°, a-H2O, and a-BaseLoss are all in the same family because they are all a-type ions. 
        private static readonly Dictionary<ProductType, ProductType[]> FragmentFamilyLookup = new()
        {
        ...
        /// <summary>
        /// Returns all product types that are in the same "family" as the input product type. This means they share a backbone cleavage site and direction. For example, a, a*, a°, a-H2O, and a-BaseLoss are all in the same family because they are all a-type ions. 
        /// </summary>
        /// <param name="productType"></param>
        /// <returns></returns>
        public static ProductType[] GetFragmentFamilyMembers(this ProductType productType)
        {
            return FragmentFamilyLookup.TryGetValue(productType, out var familyMembers) 
                ? familyMembers 
                : [];
        }
    }
