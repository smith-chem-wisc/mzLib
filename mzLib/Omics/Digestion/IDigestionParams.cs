...
namespace Omics.Digestion
{
    public interface IDigestionParams : IEquatable<IDigestionParams>
    {
        ...
        /// <summary>
        /// The agent the caller named. It is the same object as <see cref="DigestionAgent"/> except when
        /// <see cref="SearchModeType"/> is None: then <see cref="DigestionAgent"/> becomes singleN (FragmentationTerminus N) or
