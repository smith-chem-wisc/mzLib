namespace Omics.Quantification
{
    /// <summary>
    ...
    /// </summary>
    public interface IIsobaricQuantSampleInfo : IEquatable<IIsobaricQuantSampleInfo>
    {
        /// <summary>
        ...
        /// <summary>
        /// The condition or experimental group this sample belongs to (e.g., "Control", "Treatment").
        /// Used for grouping samples during statistical analysis.
        /// </summary>
        string Condition { get; }

        /// <summary>
        /// Biological replicate identifier within a condition. Distinguishes different biological
        /// samples prepared under the same condition (e.g., patient or culture replicate).
        /// </summary>
        int BiologicalReplicate { get; }

        /// <summary>
        /// Technical replicate identifier for repeated measurements of the same biological sample
        /// (e.g., multiple injections of the same preparation).
        /// </summary>
