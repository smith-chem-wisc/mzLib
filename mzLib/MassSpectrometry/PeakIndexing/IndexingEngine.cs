...
namespace MassSpectrometry
{
    ...
    public abstract class IndexingEngine<T> where T : IIndexedPeak
    {
        ...
        public virtual bool IndexPeaks(MsDataScan[] scanArray)
        {
            ...
            {
                ScanInfoArray[scanIndex] = new ScanInfo(scanArray[scanIndex].OneBasedScanNumber, scanIndex, scanArray[scanIndex].RetentionTime, scanArray[scanIndex].MsnOrder, scanArray[scanIndex].TotalIonCurrent);
