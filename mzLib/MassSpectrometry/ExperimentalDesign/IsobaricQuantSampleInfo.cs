...
namespace MassSpectrometry
{
    ...
    /// 
    /// This class defines equality, hashing, and comparison based on 
    /// <see cref="FullFilePathWithExtension"/> and <see cref="ChannelLabel"/>
    ...
    public class IsobaricQuantSampleInfo : ISampleInfo, IEquatable<IsobaricQuantSampleInfo>, IComparable<ISampleInfo>
    {
        ...
        /// <summary>
        /// A numeric identifier derived from <see cref="FullFilePathWithExtension"/> and <see cref="ChannelLabel"/>.
        ...
        /// Two samples are considered equal if they have the same <see cref="FullFilePathWithExtension"/> and <see cref="ChannelLabel"/>.
        /// </summary>
        ...
        /// with matching <see cref="FullFilePathWithExtension"/> and <see cref="ChannelLabel"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns a string representation of this sample in the format "{FileName}_{ChannelLabel}".
        /// Uses only the file name (without directory path) for readability.
        /// </summary>
        /// <returns>A display string identifying this sample by file name and channel.</returns>
        public override string ToString()
        {
            var fileName = Path.GetFileNameWithoutExtension(FullFilePathWithExtension);
            return $"{fileName}_{ChannelLabel}";
        }

        /// <summary>
        /// Compares this instance to another <see cref="ISampleInfo"/> for sorting purposes.
        /// For <see cref="IsobaricQuantSampleInfo"/> instances, compares by <see cref="FullFilePathWithExtension"/> first,
        /// then by <see cref="ChannelLabel"/>. All comparisons use ascending order 
        /// (A before B for strings). Non-null values sort before null.
        /// 
