...
namespace Readers
{
    ...
    // Class scope is to provide access to the data held in a file. That is it. 
    ...
    public class MsDataFile 
    {
        ...
        // TODO: This can be improved. I also don't think it should be in this class
        ...
        private int GetClosestOneBasedSpectrumNumber(double retentionTime)
        {
