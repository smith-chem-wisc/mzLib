...
{
    /// <summary>
    /// Implementation of the Prosit 2025 iRT prediction model supporting 22 PTM types.
    /// </summary>
    public class Prosit2025iRT22PTM : RetentionTimeModel
    {
        private static readonly UnimodSequenceFormatSchema PTMSchema = new(UnimodLabelStyle.UpperCase, '[', ']', "-", "-");
        // Koina notes.yaml for Prosit_2025_irt_22PTM: "All unimod modifications are supported."
        private static readonly ISequenceConverter Converter = CreateUnimodConverterAcceptAll(PTMSchema);

        public override string ModelName => "Prosit_2025_irt_22PTM";
