...
{
    /// <summary>
    /// Implementation of the Prosit 2025 intensity prediction model supporting 22 PTM types.
    /// </summary>
    /// <remarks>
    ...
    /// - Supports 22 PTM types
    /// - Requires fragmentation type input
    /// 
    /// API Documentation: https://koina.wilhelmlab.org/docs#post-/Prosit_2025_intensity_22PTM/infer
    /// </remarks>
    public class Prosit2025Intensity22PTM : FragmentIntensityModel
    {
        private static readonly UnimodSequenceFormatSchema PTMSchema = new(UnimodLabelStyle.UpperCase, '[', ']', "-", "-");
        // Koina notes.yaml for Prosit_2025_intensity_22PTM: "All unimod modifications are supported."
        // The "22PTM" in the model name refers to PTM–residue combinations trained on, not unique UNIMOD ids.
        private static readonly ISequenceConverter Converter = CreateUnimodConverterAcceptAll(PTMSchema);

        public override string ModelName => "Prosit_2025_intensity_22PTM";
        ...
        public Prosit2025Intensity22PTM(
