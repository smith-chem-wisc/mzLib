...
{
    /// <summary>
    /// MS2PIP iTRAQ phospho intensity prediction model.
    /// </summary>
    public class Ms2PipITRAQPhospho : FragmentIntensityModel
    {
        private static readonly UnimodSequenceFormatSchema PhosphoSchema = new(UnimodLabelStyle.UpperCase, '[', ']', "-", "-");
        private static readonly ISequenceConverter Converter = CreateUnimodConverterAcceptAll(PhosphoSchema);

        public override string ModelName => "ms2pip_iTRAQphospho";
        ...
        public override HashSet<int> AllowedCollisionEnergies => new HashSet<int>(); // Fixed HCD, no CE input
