...
namespace Proteomics.RetentionTimePrediction
{
    ...
    public class SSRCalc3
    {
        ...
        public IEnumerable<PeptideWithSetModifications> ChooseRegressionPeptides(IEnumerable<PeptideWithSetModifications> peptides, out int minCount)
        {
            minCount = 0;
            return peptides;
        }

        public IEnumerable<PeptideWithSetModifications> GetStandardPeptides(IEnumerable<PeptideWithSetModifications> peptides)
        {
