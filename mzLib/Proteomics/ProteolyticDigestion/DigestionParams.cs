...
namespace Proteomics.ProteolyticDigestion 
{
    public class DigestionParams : IDigestionParams
    {
        ...
        public DigestionParams() : this("trypsin|P")
        {
        }

        public DigestionParams(string protease = "trypsin|P", int maxMissedCleavages = 2, int minPeptideLength = 7, int maxPeptideLength = int.MaxValue,
