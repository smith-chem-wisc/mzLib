...
namespace Proteomics.Fragmentation
{
    public class DissociationTypeCollection
    {
        public static Dictionary<DissociationType, List<ProductType>> ProductsFromDissociationType = new Dictionary<DissociationType, List<ProductType>>
        {
            ...
            { DissociationType.LowCID, new List<ProductType>{ ProductType.b, ProductType.y, ProductType.a_NH3, ProductType.b_NH3, ProductType.y_NH3, ProductType.a_H2O, ProductType.b_H2O, ProductType.YH2O } },
        ...
        /// <summary>
        /// Returns the subset of product types for water and ammonia loss for the respective fragmentation types.
        /// </summary>
        /// <param name="dissociationType"></param>
        /// <param name="fragmentationTerminus"></param>
        /// <returns></returns>
        public static List<ProductType> GetWaterAndAmmoniaLossProductIonsForDissociationType(DissociationType dissociationType, FragmentationTerminus fragmentationTerminus)
        {
            ...
            switch (dissociationType)
            {
                ...
                case DissociationType.EThcD:
                    ...
                    {
                        productList.AddRange(ProductType.y_H2O, ProductType.y_NH3);
                    }
                    break;
        ...
        private static Dictionary<ProductType, double?> NeutralMassShiftFromProductType = new Dictionary<ProductType, double?>
        {
            ...
            { ProductType.a_NH3, null},//-C -O -N -H3
            { ProductType.a_H2O, null},//-C -O2 -H2
            ...
            if (NeutralMassShiftFromProductType.TryGetValue(productType, out double? shift))
            {
                if (!shift.HasValue)
                {
                    ...
                    switch (productType)
                    {
                        ...
                        case ProductType.a_NH3: NeutralMassShiftFromProductType[productType] = ChemicalFormula.ParseFormula("C-1O-1N-1H-3").MonoisotopicMass; break;
                        case ProductType.a_H2O: NeutralMassShiftFromProductType[productType] = ChemicalFormula.ParseFormula("C-1O-2H-2").MonoisotopicMass; break; // -46.0054793036,-C -O2 -H2
                        ...
                        case ProductType.YH2O: NeutralMassShiftFromProductType[productType] = 0; break;// 0, no change
