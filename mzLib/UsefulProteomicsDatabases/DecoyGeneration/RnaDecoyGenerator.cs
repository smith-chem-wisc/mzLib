            ...
            Parallel.ForEach(nucleicAcids, new ParallelOptions() { MaxDegreeOfParallelism = maxThreads }, nucleicAcid =>
            {
                ...
                if (nucleicAcid is IHasSequenceVariants variantContaining)
                {
                    ...
                    foreach (SequenceVariation variation in variantContaining.AppliedSequenceVariations)
                    {
                        ...
                        reverseAppliedVariations.Add(new SequenceVariation(reverseBegin, reverseEnd, variation.OriginalSequence, variation.VariantSequence, variation.Description, variation.VariantCallFormatData.ToString(), reverseModificationsForVariation));
                    }
                    ...
                    foreach (SequenceVariation variation in variantContaining.SequenceVariations)
                    {
                        ...
                        reverseVariations.Add(new SequenceVariation(reverseBegin, reverseEnd, variation.OriginalSequence, variation.VariantSequence, variation.Description, variation.VariantCallFormatData.ToString(), reverseModificationsForVariation));
                    }
