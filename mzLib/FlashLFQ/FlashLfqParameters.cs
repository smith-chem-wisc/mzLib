...
namespace FlashLFQ
{
    public class FlashLfqParameters
    {
        ...
        /// <summary>
        /// Retain the individual isotope peaks each envelope was summed from, and write them out as three extra
        /// columns of QuantifiedPeaks.tsv. Off by default: keeping every isotope peak of every envelope costs
        /// memory proportional to the raw data rather than to the results.
        /// </summary>
        public bool WriteVerbosePeaks { get; set; }
