...
namespace FlashLFQ.Interfaces
{
    ...
    public interface IFlashLfqIndexingEngine
    {
        ...
        public List<IIndexedPeak> GetXic(double mz, double retentionTime, PpmTolerance ppmTolerance, int missedScansAllowed, double maxPeakHalfWidth = int.MaxValue, Dictionary<IIndexedPeak, ExtractedIonChromatogram> matchedPeaks = null);
        /// <summary>
