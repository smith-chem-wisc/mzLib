...
namespace FlashLFQ
{
    public class RtInfo
    {
        ...
        public double RtStartHypothesis => PredictedRt - Math.Max((Width / 2.0), (_minimumWindowWidth / 2.0) ); // the Math.Max components ensure that the width of an RT Window is at least _minimumWindowWidth wide
        public double RtEndHypothesis => PredictedRt + Math.Max((Width / 2.0), (_minimumWindowWidth / 2.0) );
