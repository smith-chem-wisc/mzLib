...
public class TestOutlierRejection
{
    ...
    private static readonly double[] PercentileTest = new double[] { 100, 95, 90, 80, 70, 60, 50, 40, 30, 20, 10, 5, 0 };
    private static readonly double[] PercentileExpected = new double[] { 95, 90, 80, 70, 60, 50, 40, 30, 20, 10, 5 };
