    ...
    public class TestFlashDeconFiles
    {
        ...
        public void TestFlashDeconMs1TsvFirstAndLastAreCorrect()
        {
            string filePath = Path.Combine(TestContext.CurrentContext.TestDirectory,
                @"FileReadingTests\ExternalFileTypes\FlashDeconvMs1Tsv_jurkat_td_rep1_fract2_ms1.tsv");
        ...
        {
            string filePath = Path.Combine(TestContext.CurrentContext.TestDirectory,
                @"FileReadingTests\ExternalFileTypes\FlashDeconvTsv_jurkat_td_rep1_fract2.tsv");
