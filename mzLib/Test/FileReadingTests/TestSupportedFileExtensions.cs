...
namespace Test.FileReadingTests
{
    ...
    internal class TestSupportedFileExtensions
    {
        private static IEnumerable<TestCaseData> SupportedFileTypeTestCases()
        {
            ...
            yield return new TestCaseData(@"FileReadingTests\ExternalFileTypes\EditedMSFraggerResults\Intralinks.tsv", SupportedFileType.IntralinkResults);
            yield return new TestCaseData(@"FileReadingTests\ExternalFileTypes\EditedMSFraggerResults\Intralinks_MIons.tsv", SupportedFileType.IntralinkResults);
        }
