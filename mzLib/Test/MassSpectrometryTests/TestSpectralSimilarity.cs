...
namespace Test.MassSpectrometryTests
{
    ...
    public sealed class TestSpectralSimilarity
    {
        ...
        public void TestAllSpectrumSimilaritiesWithoutMzFilter()
        {
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.8).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.59).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.70).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.66).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(0.42).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.17).Within(0.01));
            NUnit.Framework.Assert.That(s.SearleSimilarity(), Is.EqualTo(2.4391).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.SpectralEntropy(), Is.EqualTo(0.79).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.27).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.17).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.37).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.22).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.87).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.33).Within(0.01));

            s = new SpectralSimilarity(experimentalSpectrum, theoreticalSpectrum, SpectralSimilarity.SpectrumNormalizationScheme.SpectrumSum, ppmTolerance, true, 0);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.27).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.17).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-.03).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.17).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.87).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.17).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.41).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.27).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.07).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.24).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.90).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.24).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.27).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.17).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-6.21).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.29).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.87).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(4).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.18).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.77).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0).Within(0.01));
            ...
            Assert.AreEqual(4, s.IntensityPairs.Count);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.48).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.32).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.33).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.33).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.33).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.20).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.23).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.945).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.33).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.50).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.33).Within(0.01));
        ...
        public void TestAllSpectrumSimilaritiesWithDefaultedMzFilter()
        {
            ...
            Assert.AreEqual(8, s.IntensityPairs.Count);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.68).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.48).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.65).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.56).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(0.02).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.13).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.70).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.49).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.61).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.58).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.04).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.16).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.903).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.718).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.76).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.712).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(0.475).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.126).Within(0.01));
            ...
            Assert.AreEqual(4, s.IntensityPairs.Count);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.924).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.75).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.751).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.734).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(0.681).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.164).Within(0.01));
            ...
            Assert.AreEqual(5, s.IntensityPairs.Count);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.894).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.704).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.736).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.743).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(0.812).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.244).Within(0.01));
            ...
            Assert.AreEqual(3, s.IntensityPairs.Count);
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.267).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.172).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.374).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.222).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.866).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.333).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.247).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.866).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.23).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-0.949).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(0.55).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(0.37).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(-0.05).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.50).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-1).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.67).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.EqualTo(1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.EqualTo(1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.EqualTo(0.67).Within(0.01));
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.EqualTo(0.80).Within(0.01));
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.EqualTo(-1.0).Within(0.01));
            NUnit.Framework.Assert.That(s.DotProduct(), Is.EqualTo(0.67).Within(0.01));
            ...
            NUnit.Framework.Assert.That(s.CosineSimilarity(), Is.Null);
            NUnit.Framework.Assert.That(s.SpectralContrastAngle(), Is.Null);
            NUnit.Framework.Assert.That(s.EuclideanDistance(), Is.Null);
            NUnit.Framework.Assert.That(s.BrayCurtis(), Is.Null);
            NUnit.Framework.Assert.That(s.PearsonsCorrelation(), Is.Null);
        ...
        public void TestKullbackLeiblerDivergence()
        {
            ...
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q(), Is.EqualTo(0.0853).Within(0.001));
            ...
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q(), Is.EqualTo(0.0853).Within(0.001));
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q(), Is.EqualTo(s.KullbackLeiblerDivergence_P_Q(correctionConstant: 0)).Within(0.001));
            ...
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q(), Is.EqualTo(3.467).Within(0.01));
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q() > s.KullbackLeiblerDivergence_P_Q(correctionConstant: 0));
            ...
            s = new(p_XArray, p_YArray, q_XArray, q_YArray,
                SpectralSimilarity.SpectrumNormalizationScheme.SpectrumSum, ppmTolerance, true, 0);
            // With correction, this should increase divergence for missing peaks
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q(), Is.GreaterThan(3));
            NUnit.Framework.Assert.That(s.KullbackLeiblerDivergence_P_Q() > s.KullbackLeiblerDivergence_P_Q(correctionConstant: 0));
