...
namespace Test.Omics
{
    ...
    internal class SpectralMatchTests
    {
        ...
        /// </summary>
        private class TestableSpectralMatch : SpectralMatchWithFragmentData
        {
        ...
        {
            var match = new SpectralMatchWithFragmentData("path/to/file.mzML", 42, 100.5, "PEP[Phospho]TIDE", "PEPTIDE");
        ...
        {
            var match = new SpectralMatchWithFragmentData(null!, 1, 10.0, "SEQ", "SEQ");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, null!, "SEQ");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "SEQ", null!);
        ...
        public void Constructor_WithIdentifiedBioPolymers_StoresThem()
        {
            ...
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "ABC", "ABC", new[] { polymer1, polymer2 });
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "SEQ", "SEQ", null);
        ...
        public void Constructor_DefensiveCopy_OriginalListMutationDoesNotAffectMatch()
        {
            ...
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "A", "A", source);
        ...
        public void GetIdentifiedBioPolymersWithSetMods_ReturnsAllProvided()
        {
            var polymers = Enumerable.Range(1, 5)
                ...
                .ToList();
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "SEQ1", "SEQ1", polymers);
        ...
        public void GetIdentifiedBioPolymersWithSetMods_PreservesOrder()
        {
            ...
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "SEQ", "SEQ", polymers);
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "SEQ", "SEQ");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "PEPTIDE", "PEPTIDE");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 10.0, "", "");
        ...
        {
            var higher = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
            var lower = new SpectralMatchWithFragmentData("file", 1, 50.0, "SEQ", "SEQ");
        ...
        {
            var a = new SpectralMatchWithFragmentData("a_file", 1, 100.0, "SEQ", "SEQ");
            var b = new SpectralMatchWithFragmentData("b_file", 1, 100.0, "SEQ", "SEQ");
        ...
        {
            var scan5 = new SpectralMatchWithFragmentData("file", 5, 100.0, "SEQ", "SEQ");
            var scan10 = new SpectralMatchWithFragmentData("file", 10, 100.0, "SEQ", "SEQ");
        ...
        {
            var a = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
            var b = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
        ...
        {
            IHasSequenceCoverageFromFragments match = new SpectralMatchWithFragmentData("file", 1, 10.0, "PEPTIDE", "PEPTIDE");
        ...
        public void IHasSequenceCoverageFromFragments_Sorting_WorksCorrectly()
        {
            var matches = new List<IHasSequenceCoverageFromFragments>
                {
                    new SpectralMatchWithFragmentData("file", 1, 50.0, "SEQ", "SEQ"),
                    new SpectralMatchWithFragmentData("file", 2, 100.0, "SEQ", "SEQ"),
                    new SpectralMatchWithFragmentData("file", 3, 75.0, "SEQ", "SEQ")
                };
            ...
            Assert.That(((SpectralMatchWithFragmentData)matches[0]).Score, Is.EqualTo(100.0));
            Assert.That(((SpectralMatchWithFragmentData)matches[1]).Score, Is.EqualTo(75.0));
            Assert.That(((SpectralMatchWithFragmentData)matches[2]).Score, Is.EqualTo(50.0));
        }
        ...
        {
            var a = new SpectralMatchWithFragmentData("file", 42, 100.0, "PEP[Mod]TIDE", "PEPTIDE");
            var b = new SpectralMatchWithFragmentData("file", 42, 100.0, "PEP[Mod]TIDE", "PEPTIDE");
        ...
        {
            var a = new SpectralMatchWithFragmentData("file1", 1, 100.0, "SEQ", "SEQ");
            var b = new SpectralMatchWithFragmentData("file2", 1, 100.0, "SEQ", "SEQ");
        ...
        {
            var a = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
            var b = new SpectralMatchWithFragmentData("file", 2, 100.0, "SEQ", "SEQ");
        ...
        {
            var a = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ1", "SEQ");
            var b = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ2", "SEQ");
        ...
        public void Equals_DifferentScore_StillReturnsTrue()
        {
            ...
            var a = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
            var b = new SpectralMatchWithFragmentData("file", 1, 50.0, "SEQ", "SEQ");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
        ...
        {
            SpectralMatchWithFragmentData? a = null;
            SpectralMatchWithFragmentData? b = null;
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 42, 123.456, "PEP[Mod]TIDE", "PEPTIDE");
        ...
        {
            var match = new SpectralMatchWithFragmentData("file", 1, 100.00, "SEQ", "SEQ");
        ...
        {
            // Create match
            var match = new SpectralMatchWithFragmentData("test.mzML", 100, 85.5, "PEP[Phospho]TIDE", "PEPTIDE");
        ...
        {
            var match1 = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ");
            var match2 = new SpectralMatchWithFragmentData("file", 1, 100.0, "SEQ", "SEQ"); // Equal to match1
            var match3 = new SpectralMatchWithFragmentData("file", 2, 100.0, "SEQ", "SEQ"); // Different scan

            var hashSet = new HashSet<SpectralMatchWithFragmentData> { match1, match2, match3 };
        ...
        {
            var matches = new List<SpectralMatchWithFragmentData>
            {
                new SpectralMatchWithFragmentData("file", 1, 50.0, "SEQ", "SEQ"),
                new SpectralMatchWithFragmentData("file", 2, 100.0, "SEQ", "SEQ"),
                new SpectralMatchWithFragmentData("file", 3, 75.0, "SEQ", "SEQ")
