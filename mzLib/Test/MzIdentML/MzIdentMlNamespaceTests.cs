...
namespace Test.MzIdentML
{
    ...
    /// .../1.1.1, 1.2.0 declares .../1.2 and 1.3.0 declares .../1.3 (HUPO-PSI/mzIdentML, schema/*.xsd).
    ///
    ...
    public sealed class MzIdentMlNamespaceTests
    {
        ...
        private const string Namespace130 = "http://psidev.info/psi/pi/mzIdentML/1.3";
        ...
        [TestCase(typeof(mzIdentML130.Generated.MzIdentMLType130), Namespace130)]
