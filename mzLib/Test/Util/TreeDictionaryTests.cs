...
{
    /// <summary>
    /// Tests for SpectrumTree / TreeDictionary.
    ///
    /// These were written into Test/TestMzLibUtil.cs, which master has since split into
    /// Test/Util/*.cs -- so the merge arrived as a modify/delete conflict. They are carried over
    /// here under the one-file-per-class convention their new siblings follow (DictionaryPoolTests,
    /// HashSetPoolTests, ListPoolTests) rather than reinstated at the old path. The test bodies are
    /// unchanged from the branch.
    /// </summary>
    [TestFixture]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed class TreeDictionaryTests
    {
