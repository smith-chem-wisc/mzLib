...
namespace Test
{
    ...
    public class DatabaseLoaderTests
    {
        ...
        public void Modification_read_write_into_proteinDb()
        {
            ...
            List<Protein> new_proteins = ProteinDbLoader.LoadProteinXML(Path.Combine(TestContext.CurrentContext.TestDirectory, "test_modifications_with_proteins.xml"), false, new List<Modification>(), false, null, out Dictionary<string, Modification> um);
        ...
        public void DoNotWriteSameModTwiceAndDoNotWriteInHeaderSinceDifferent()
        {
            ...
            Assert.AreEqual(0, ProteinDbWriter.WriteXmlDatabase(dictWithThisMod, new List<Protein> { protein }, Path.Combine(TestContext.CurrentContext.TestDirectory, "test_modifications_with_proteins3.xml")));
        ...
        public void DoNotWriteSameModTwiceButWriteInHeaderSinceDifferent()
        {
            ...
            Assert.AreEqual(0, ProteinDbWriter.WriteXmlDatabase(dictWithThisMod, new List<Protein> { protein }, Path.Combine(TestContext.CurrentContext.TestDirectory, "test_modifications_with_proteins2.xml")));
