...
namespace Test
{
    ...
    {
        public Ms2ScanWithSpecificMass(MsDataScan mzLibScan, double precursorMonoisotopicPeakMz, int precursorCharge, string fullFilePath, IsotopicEnvelope[] neutralExperimentalFragments = null)
        {
            ...
            ExperimentalFragments = neutralExperimentalFragments ?? GetNeutralExperimentalFragments(mzLibScan);
        ...
        public static IsotopicEnvelope[] GetNeutralExperimentalFragments(MsDataScan scan)
        {
            int minZ = 1;
            int maxZ = 10;

            var neutralExperimentalFragmentMasses = scan.MassSpectrum.Deconvolute(scan.MassSpectrum.Range,
                minZ, maxZ, 4, 3).ToList();
