...
namespace Test
{
    ...
    public class TestDatabaseLoaders
    {
        ...
        {            
            var protein = ProteinDbLoader.LoadProteinFasta(Path.Combine(TestContext.CurrentContext.TestDirectory, "DatabaseTests", "Isoform.fasta"), true, DecoyType.None, false, out var errors);
        ...
        public static void IsoformReadTest()
        {
            ...
            var proteinList = ProteinDbLoader.LoadProteinFasta(filepath, true, DecoyType.None, false, out var dbErrors);
