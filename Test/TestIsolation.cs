...
namespace Test
{
    ...
    public sealed class TestIsolation
    {
        ...
        public void TestCoIsolation()
        {
            ...
            var isolatedMasses = cool.GetIsolatedMassesAndCharges(myMsDataFile.GetOneBasedScan(cool.OneBasedPrecursorScanNumber.Value).MassSpectrum, 1, maxAssumedChargeState, 10, 5,2, 0.4, 0.4, 2).ToList();
