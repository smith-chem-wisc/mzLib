...
namespace Test
{
    ...
    public sealed class SpectrumTestFixture
    {
        ...
        public void FilterByNumberOfMostIntenseRobTest()
        {
            ...
            MzSpectrumZR spectrum = new MzSpectrumZR(x, y, false);
        ...
        {
            _mzSpectrumA = new MzSpectrumZR(new double[] { 5, 6, 7 }, new double[] { 1, 2, 3 }, false);
        ...
        public void TestGetClosestPeakXValue()
        {
            ...
            Assert.IsNull(new MzSpectrumZR(new double[0], new double[0], false).GetClosestPeakXvalue(1));
        }
        ...
        public void TestNumPeaksWithinRange()
        {
            ...
            var thisSpectrum = new MzSpectrumZR(xArray, yArray, false);
